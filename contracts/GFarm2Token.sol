    ...
    ContextMixin
{
    ...
    uint public constant MIN_GRANT_REQUEST_DELAY = 45000; // 1 day
    ...
    function updateTrading(address trading) external only(DEFAULT_ADMIN_ROLE) {
        // Trading roles
        _setupRole(MINTER_ROLE, trading);
        _setupRole(BURNER_ROLE, trading);
    }
